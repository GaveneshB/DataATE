...
<head>
    ...
    <title>Pick Up - DataATE</title>
    <link rel="stylesheet" href="{{ asset('css/pickup_form.css') }}">
...
<body>
    <div class="pickup-container">
        ...
        <header class="pickup-header">
            <button class="back-btn" onclick="goBack()">
                <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.5 17L8.5 11.5L14.5 6" stroke="#1A1A1A" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </button>
        ...
        <div class="progress-section">
            ...
            <div class="progress-labels">
                <span>Booking</span>
                <span class="active">Pick Up</span>
                <span>Complete</span>
            </div>
        </div>
        ...
        <!-- Form Content -->
        <form id="pickupForm" class="pickup-form" enctype="multipart/form-data">
            @csrf
                ...
                <div class="upload-card" id="carImagesCard">
                    <div class="upload-area" onclick="document.getElementById('carImages').click()">
                        <div class="upload-icon">
                            <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="50" height="50" rx="25" stroke="#263955"/>
                                <path d="M25.5 18V33" stroke="#000" stroke-width="1.2" stroke-linecap="round"/>
                                <path d="M18 25.5H33" stroke="#000" stroke-width="1.2" stroke-linecap="round"/>
                            </svg>
                        </div>
                    ...
                    <div class="example-section">
                        ...
                        <div class="example-images">
                            <div class="example-placeholder" id="exampleImageContainer">
                                <img id="exampleImage" 
                                     src="{{ asset('image/car-example-front.jpg') }}" 
                                     alt="Front view example" 
                                     style="display: none;">
                                <div class="example-text" id="examplePlaceholder">
            ...
            <!-- Pick Up Fuel Level Section -->
            <section class="form-section">
                <h2 class="section-title">Pick Up Fuel Level</h2>
                <p class="section-desc">Select your fuel level during pick up</p>
            ...
            <!-- Upload Agreement Form Section -->
            <section class="form-section">
                <h2 class="section-title">Upload Your Agreement Form</h2>
                <p class="section-desc">Upload your form here (PDF format only).</p>
                
                <div class="upload-card" id="agreementCard">
                    ...
                    <input type="file" id="agreementForm" name="agreement_form" accept=".pdf,application/pdf" hidden>
                    
                    <div class="example-section">
                        <span class="example-label">For example:</span>
                        <div class="example-files">
                            <span class="file-example">agreement_form.pdf</span>
                        </div>
                    </div>
                    
                    <div class="file-preview" id="agreementPreview"></div>
                </div>
            </section>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const placeholder = document.getElementById('examplePlaceholder');
    ...
    <script src="{{ asset('js/pickup_form.js') }}"></script>
</body>
</html>